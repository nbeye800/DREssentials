...
<li><a href="{{ route('view_uploaded_schedules.blade.php') }}">view uploaded schedules</a></li>
...
<a href="{{ route('upload.blade.php') }}" class="btn-custom" data-aos="fade-up" data-aos-delay="400"><span>Uploadpdf</span></a> 
</div>
</div>
</div>
