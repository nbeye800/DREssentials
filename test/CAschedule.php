    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="DRschedule-content my-5">
          <iframe src="/DREssentials/test/assets/pdf/CA_schedule.pdf" style="width:100%; height:500px;" frameborder="0"></iframe>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <ul>
              <li>Moise: 000-000-2345</li>
              <li>Devon: 111-111-2345</li>
            </ul>
            </div>
          </div>
        </div>
